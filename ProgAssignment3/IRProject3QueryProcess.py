...
if __name__ == '__main__':
    ...
    print(f"Time to complete DVI: {elapsedTime}")
        ...
        for rawNextLine in fullFile:
            if rawNextLine == '\n':
                ...
                # hit end of paragraph, time to empty out the tokens
                    ...
                    if currentDocID == 763:
                        currentQueryVectorLengthTable = currentQueryVectorLengthTable.round({'QueryTFIDF': 3})
                    ...
                    newRankedList['Rank'] = newRankedList.reset_index().index + 1
                    ...
                    print(f"*{datetime.datetime.now()}* Done Query {currentDocID}")
    ...
    print(f"*{datetime.datetime.now()}* Done Query Processing")
    ...
    endTime = time.time()
    elapsedTime = endTime - startTime
    print(f"Time to complete entire query processing: {elapsedTime}")
